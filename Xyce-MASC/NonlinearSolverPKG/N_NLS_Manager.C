...
bool Manager::calcTransientAdjoint (bool timePoint,
      ...
      std::vector<double> & scaled_dOdpVec, std::vector<double> & scaled_dOdpAdjVec,int time_point)
{
  bool bsuccess = true;
  ...
  bsuccess = nlsSensitivityPtr_->solveTransientAdjoint(timePoint,
      objectiveVec, dOdpVec, dOdpAdjVec, scaled_dOdpVec, scaled_dOdpAdjVec, time_point);
