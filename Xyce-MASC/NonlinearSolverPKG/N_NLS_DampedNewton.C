...
vector< vector< vector<double> > >save_data;
using std::cout;
...
int DampedNewton::solve(NonLinearSolver * nlsTmpPtr)
{
  ...
  printf("go to DampedNewton::solve\n");
  ...
  while (convergedStatus == 0)
  {
    ...
    //vector< vector<double> > save_data;
//    vector< vector<double> > save_data;
    std::cout<<"the pos of s_d2 is:"<<&save_data<<"\n";
    //save_data.clear();


//    vector< vector<double> > step_jac_save;
//    for(int i=0;i<jacobianMatrixPtr_->getNumRows();++i){
//        vector<double> temp;
//        for(int j=0;j<jacobianMatrixPtr_->getRowLength(i);++j){
//           std::cout<< *(jacobianMatrixPtr_->returnRawEntryPointer(i,j))<<"  ";
//           temp.push_back(*(jacobianMatrixPtr_->returnRawEntryPointer(i,j)));
//        }
//        std::cout<<"\n";
//        step_jac_save.push_back(temp);
//        temp.clear();
//    }

//    save_data.push_back(step_jac_save);
//    step_jac_save.clear();
//    std::cout<<"\n\n";
    //int test=777777;
...
//        cout<<"\n";
    ...
    temp_str=temp_str+"\n";
//    cout<<"damp one step back"<<"\n";
//    cout<<"\n";
    write_file(temp_str,"./dQdxTrans.txt",1);
    temp_str="";
...
//    cout<<"damp two steps back\n";
    write_file(temp_str,"./dFdxTrans.txt",1);
    temp_str="";
