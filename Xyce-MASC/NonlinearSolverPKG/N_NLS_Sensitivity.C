...
//  for(int i=0;i<savedNewtonVectorPtr_->localLength();++i){
//      cout<<"test $$$\n";
//  }
//  savedNewtonVectorPtr_->print(cout);
  ...
  //jacobianMatrixPtr_->print(cout);



//  for(int i=0;i<jacobianMatrixPtr_->getNumRows();++i){
//      for(int j=0;j<jacobianMatrixPtr_->getRowLength(i);++j){
//         cout<< *(jacobianMatrixPtr_->returnRawEntryPointer(i,j))<<"  ";
//      }
//      cout<<"\n";
//  }
...
int Sensitivity::solveTransientAdjoint (bool timePoint,
       ...
       int time_point)
{
//  std::cout<<"solveTransientAdjoint\n";
...
//new version
//此处利用瞬态过程中保存数据，若想利用保存的数据，取消注释，并注视之后else中的加载过程
  ...
  if(fast_sens){
      Jac.put(0.0);
      Jac.add(*(ds.Jac_v[time_point]));
      Linear::Vector & rhs=*(ds.RHSVectorPtr);
      rhs=*(ds.rhs_v[time_point]);
  }
...
//  dfdx.add(*(ds.dfdx_v[time_point]));


//  Jac.addOverlap(*(ds.Jac_v[time_point]));



//    {
//        string temp_str;
//        for(int i=0;i<Jac.getNumRows();++i){
//            for(int j=0;j<Jac.getRowLength(i);++j){
//      //           cout<< *(ds.dFdxMatrixPtr->returnRawEntryPointer(i,j))<<"  ";
//               temp_str=temp_str+d2s(*(Jac.returnRawEntryPointer(i,j)),0)+"  ";
//            }
//      //        cout<<"\n";
//            temp_str=temp_str+"\n";
//        }
...
//  if(!virtual_){
//      Linear::Matrix & Jac = *(ds.Jac_v[time_point]);
//  }
...
//      temp_str=temp_str+"\n";
//    //    cout<<"damp two steps back\n";
//      write_file(temp_str,"./compare/JC_used.txt",1);
//      temp_str="";
//  }
...
//      cout<<"one step back"<<"\n";
//      cout<<"\n";
      write_file(temp_str,"./dQdxSens.txt",1);
      temp_str="";
...
//          cout<<"\n";
      ...
      temp_str=temp_str+"\n";
//      cout<<"two steps back\n";
      write_file(temp_str,"./dFdxSens.txt",1);
      temp_str="";
*/
    }
...
//          temp_str=temp_str+"\n";
//        //    cout<<"damp two steps back\n";
//          write_file(temp_str,"./dQdxTrans3.txt",1);
//          temp_str="";
